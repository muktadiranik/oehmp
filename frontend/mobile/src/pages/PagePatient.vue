        ...
        <template v-if="isDoctor">
          <q-tab-panel name="qr">
            <div class="qr-card flex column justify-center items-center">
              ...
              <div class="q-px-lg q-py-sm text-body1 text-grey">Share the QR code</div>
            </div>
          </q-tab-panel>
          <q-tab-panel name="dscan">
            <div class="qr-card flex column justify-center items-center">
              <qr-code-scanner :add-patient="true" />
              <div class="q-px-lg q-py-sm text-body1 text-grey">Scan the QR code</div>
            </div>
          </q-tab-panel>
